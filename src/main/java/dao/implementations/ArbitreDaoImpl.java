...
public class ArbitreDaoImpl extends DAO implements ArbitreDao {
	...
	/**
	 * Récupération de la liste des 10 derniers arbitres rentrés la base de
	 * données
	 * 
	 * @return La liste des arbitres
	 */
	...
	public List<Arbitre> recupLesDixDerniersArbitres() {
		...
		tx.begin();
		@SuppressWarnings("unchecked")
		List<Arbitre> lstDixArbitres = em.createQuery("SELECT a FROM Arbitre a ORDER BY a.idArbitre DESC")
