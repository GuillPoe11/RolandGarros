			...
			<s:form id="Select" action="EnregistrerScoreMatchTest" theme="simple">
				...
				<table id="form-table" class="table">
					...
					<tr>
						...
						<td><s:textfield id="duree" name="duree"
								onkeypress="verif(event,'duree')" label="Durée du match"
								cssClass="form-control"></s:textfield> <span id="errorDuree"
							class="msgErrorJs">Seuls les chiffres sont autorisés</span></td>
					</tr>
					<tr>
						<td>Score du premier joueur/equipe</td>
						<td><s:textfield name="score1"
								onkeypress="verif(event,'score1')"
								label="Score du premier joueur" cssClass="form-control"></s:textfield>
							<span id="errorScore1" class="msgErrorJs">Seuls les
								chiffres de 0 à 5 sont autorisés</span></td>
					</tr>
					<tr>
						<td>Score du deuxieme joueur/equipe</td>
						<td><s:textfield name="score2"
								onkeypress="verif(event,'score2')"
								label="Score du deuxième joueur" cssClass="form-control"></s:textfield>
							<span id="errorScore2" class="msgErrorJs">Seuls les
								chiffres de 0 à 5 sont autorisés</span></td>
					</tr>
					<tr>
						<td>Date du match</td>
